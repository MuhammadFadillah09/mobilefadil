      ...
      {loading ? (
        ...
        <Animated.ScrollView
          ...
          <TouchableOpacity
              ...
              style={{ backgroundColor: colors.blue(), paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8 }}>
              <Text style={{ color: colors.white(), fontFamily: fontType['Pjs-Medium'], fontSize: 12 }}>Edit</Text>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={handleDelete}
              style={{ backgroundColor: 'red', paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8 }}>
              <Text style={{ color: colors.white(), fontFamily: fontType['Pjs-Medium'], fontSize: 12 }}>Delete</Text>
            </TouchableOpacity>
        </Animated.ScrollView>
      )}
      <Animated.View
