...
const BlogDetail = ({route}) => {
  ...
  const getBlogById = async () => {
    try {
      ...
      const response = await axios.get(
        `https://6839b2846561b8d882b15a6a.mockapi.io/api/blog/${blogId}`,
      );
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await axios.delete(`https://6839b2846561b8d882b15a6a.mockapi.io/api/blog/${blogId}`);
        ...
        <Animated.ScrollView
          ...
          <View style={styles.titleWrapper}>
            <Text style={styles.title}>{selectedBlog?.title}</Text>
              ...
              <TouchableOpacity onPress={navigateEdit} style={styles.actionButton}>
                <Text style={styles.actionButtonText}>Edit</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={handleDelete} style={[styles.actionButton, {backgroundColor: '#ff4d4d'}]}>
